...
Cypress.Commands.add("registerUserByAPI", (userCredentials) => {
    return cy.registerUserWithAPI(userCredentials)
})
...
Cypress.Commands.add("deleteUserByAPI", (userCredentials) => {
    return cy.deleteUserWithAPI(userCredentials)
})
